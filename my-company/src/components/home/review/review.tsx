...
export default function Review() {
  return (
    <div className="bg-[#151515] text-white py-16">
      <h1 className="text-red-500 text-4xl tablet:text-6xl text-center font-semibold mx-2">NO.1 GAMING BRAND, DI DUNIA</h1>
      <p className="text-white text-center text-2xl tablet:text-4xl font-semibold mt-4 mx-2">Apa kata media mengenai ROG</p>
