        ...
        <tbody>
          {
            data.map((user, idx) =>
              <tr key={idx} className="hover:bg-slate-200 hover:cursor-pointer">
                <td onClick={() => navigate(`/${user.id}`)} className="p-2 border border-slate-300">{idx + 1}</td>
                <td onClick={() => navigate(`/${user.id}`)} className="p-2 border border-slate-300">{user.username}</td>
                <td onClick={() => navigate(`/${user.id}`)} className="p-2 border border-slate-300">{user.email}</td>
