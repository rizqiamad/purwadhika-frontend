  ...
  return (
    <div className="hero min-h-screen relative overflow-hidden" style={{
      ...
      <div className="hero-content text-neutral-content max-lg:flex-col max-lg:py-20 max-lg:gap-10">
        ...
        >
          <div style={{ backgroundImage: `url(/programmer.png)` }} className="w-[26rem] h-[28rem] bg-cover rounded-xl max-lg:w-[35rem] max-sm:w-[26rem] animate-rightIn ease-linear"></div>
        </motion.div>
      </div>
    </div>
  )
