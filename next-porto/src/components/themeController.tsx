...
export default function ThemeController() {
  ...
  return (
    <label className="swap swap-rotate">
      ...
      <input type="checkbox" className="theme-controller" value="synthwave" onChange={handleToogle} checked={theme === 'light' ? false : true} />
      ...
      {/* moon icon */}
      <svg
        className="swap-on h-6 w-6 fill-current dark:text-white"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24">
        <path
