    ...
    <main className="flex justify-evenly min-h-[100vh] items-center max-md:flex-col py-16 dark:bg-donker" id='contact'>
      ...
      >
        <form action="POST" className="flex flex-col">
          <input type="text" placeholder="Enter your Name" className="w-[400px] h-[50px] px-5 mb-5 text-xl border-solid border-2 border-black dark:border-none dark:text-white" />
          <input type="text" placeholder="Enter a valid email address" className="w-[400px] h-[50px] px-5 mb-5 text-xl border-solid border-2 border-black dark:border-none dark:text-white" />
          <textarea name="message" id="message" placeholder="Enter your message" className="w-[400px] h-[150px] p-5 mb-5 text-xl border-solid border-2 border-black dark:border-none dark:text-white"></textarea>
